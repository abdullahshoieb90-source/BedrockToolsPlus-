...
**HUD:** Ping Counter, Reach Counter, Combo Display, Break Indicator, Player Coords, Compass, Speed Display, Effect Display, No Potion Bar, Debug Menu, Keystrokes, Tablist, Crosshair, ArmorHUD, Hotbar Slots, Inventory HUD, World Time, Arrow Counter, Totem Counter
