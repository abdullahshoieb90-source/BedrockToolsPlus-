...
- Minecraft Bedrock **1.26.51** (`1.26.5X.X` wildcard, same as upstream QYCottage/BedrockTools v1.5.6) — the version declared in `levimod.json`; other builds may work but are untested
